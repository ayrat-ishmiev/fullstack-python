...
class MainWindow(QMainWindow):
    # ОБНОВЛЕННЫЙ ТЕКСТ: Использование чистого HTML для корректного отображения
    INSTRUCTIONS_HTML = """
        <h1>🚀 Инструкция: Как пользоваться приложением</h1>
        <hr>
        <h2>⭐ Основные функции</h2>
        <p>Это приложение помогает вам <b>организовать учебные материалы</b> и <b>работать с ними с помощью нейросети</b>.</p>
        <ul>
            <li>Вы можете создавать <b>Предметы</b> (например, "Математика", "Программирование") и добавлять к ним <b>Конспекты</b> в виде файлов.</li>
            <li>Удаление предметов: Нажмите <b>правую кнопку мыши</b> по соответствующему предмету.</li>
            <li><b>Поддерживаемые форматы:</b> Текстовые (.txt), документы (.pdf, .docx), изображения (.jpg, .png), аудио (.mp3) и видео (.mp4).</li>
            <li><b>Нейросеть:</b> Задавайте вопросы по материалам. Она будет искать ответы в ваших конспектах, а также найдёт нужные с помощью <b>умного поиска</b>.</li>
        </ul>
        <hr>
        <h2>💡 Контроль данных и управление</h2>
        <ul>
            <li>Вы можете <b>загружать и выгружать</b> все конспекты с помощью <b>CSV-файлов</b> для удобства переноса.</li>
            <li>Все данные <b>автоматически сохраняются</b>.</li>
            <li>Для выхода используйте клавишу <b>Escape</b> – программа спросит, нужно ли сохранить изменения.</li>
        </ul>
        <hr>
        <h2>⚙️ Пошаговая инструкция (Как работать)</h2>
        <ol>
            <li><b>Создайте Предмет:</b> На главном экране нажмите кнопку <b>"Добавить предмет"</b>.</li>
            <li><b>Загрузите Конспект:</b> Выберите предмет и добавьте файлы-конспекты через <b>"Добавить конспект"</b>.</li>
            <li><b>Задайте Вопрос:</b> Откройте предмет, выберите конспект и нажмите <b>"Задать вопрос нейросети"</b> или используйте умный поиск.</li>
        </ol>
    """
    ...
    # ИСПРАВЛЕННЫЙ МЕТОД: Использует QDialog и QTextBrowser для корректного отображения HTML
